...
export const THREE_D_PROVIDERS: ThreeDProviderDefinition[] = [
  ...
  },
  {
    ...
    models: ['tripo-v3.1', 'tripo-v3.0', 'tripo-p1', 'tripo-v2.5'],
    needsKey: true,
    local: false,
  ...
  },
  {
    ...
    models: ['tencent/generate/rapid', 'tencent/generate/precise', 'hunyuan3d-v2.1'],
    needsKey: true,
    local: false,
  ...
  },
  {
    ...
    models: ['tripo/text-to-3d/3.1', 'tripo/text-to-3d/3.0', 'meshy/text-to-3d'],
    needsKey: true,
    local: false,
    defaultBaseUrl: 'https://api.3daistudio.com',
    supportsBaseUrl: true,
  ...
  },
  {
    ...
    models: ['fal-ai/triposr/tripo-v3.1/text-to-3d', 'fal-ai/tripo3d'],
    needsKey: true,
    local: false,
    defaultBaseUrl: 'https://queue.fal.run',
    supportsBaseUrl: true,
  ...
  },
  {
    ...
    models: ['tencent/Hunyuan3D-2.1', 'tencent/Hunyuan3D-2.5', 'tencent/Hunyuan3D-2mini'],
    needsKey: true,
    local: false,
  ...
  },
  {
    ...
    models: ['Hunyuan3D-2.5', 'Hunyuan3D-2.1', 'Hunyuan3D-2mini'],
    needsKey: false,
    local: true,
